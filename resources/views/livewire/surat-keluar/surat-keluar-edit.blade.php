        ...
        <x-slot name="content">
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input wire:model="form.tanggal_surat" type="text" id="tanggal_surat" required @readonly(true) class="input input-bordered w-full">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input wire:model="form.nomor_surat" type="text" id="nomor_surat" class="input input-bordered w-full" required @readonly(true) placeholder="Masukkan Nomor Surat">
