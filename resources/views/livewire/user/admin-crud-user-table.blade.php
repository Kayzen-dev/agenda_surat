            ...
            <tr>
                ...
                <td class="text-center">
                    ...
                    <x-danger-button 
                        ...
                        {!! $item->status_login ? '<a href="' . route('logout', ['id' => $item->id, 'route' => 'users']) . '" class="btn btn-xs">Logout Akun</a>' : '' !!}
                ...
                <td>
                    <div class="{{ $item->status_login == true ? 'badge badge-success' : 'badge badge-warning' }}">
                        {{ $item->status_login == true ? 'Sedang' : 'non-aktif' }} 
                    </div>
                    
                </td>
                <td>
                    <div class="{{ $item->email_verified_at != null ? 'badge badge-success' : 'badge badge-warning' }}">
                        {{ $item->email_verified_at != null ? 'Aktif' : 'non-aktif' }}
                    </div>
                </td>
